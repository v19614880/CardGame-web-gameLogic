...
//                try {
//                    Thread.sleep(BasicCommands.playUnitAnimation(out, unit, UnitAnimationType.move));
//                } catch (InterruptedException e) {
//                    e.printStackTrace();
//                }
//
...
//                try {
//                    Thread.sleep(BasicCommands.playUnitAnimation(out, unit, UnitAnimationType.attack));
//                } catch (InterruptedException e) {
//                    e.printStackTrace();
//                }
//
//                // playUnitAnimation [Attack] and wait for a period until the animation does one cycle
//                try {
//                    Thread.sleep(BasicCommands.playUnitAnimation(out, unit, UnitAnimationType.hit));
//                } catch (InterruptedException e) {
//                    e.printStackTrace();
//                }
//
//                // playUnitAnimation [Attack] and wait for a period until the animation does one cycle
//                try {
//                    Thread.sleep(BasicCommands.playUnitAnimation(out, unit, UnitAnimationType.channel));
//                } catch (InterruptedException e) {
//                    e.printStackTrace();
//                }
//
...
//                try {
//                    Thread.sleep(BasicCommands.playUnitAnimation(out, unit, UnitAnimationType.death));
//                } catch (InterruptedException e) {
//                    e.printStackTrace();
//                }
//
...
//        avatarsAndTokens.add(StaticConfFiles.HUMAN_AVATAR);
//        avatarsAndTokens.add(StaticConfFiles.AI_AVATAR);
...
//        }
        ...
        for (String filename : new File(effectsDIR).list()) {
            ...
            BasicCommands.addPlayer1Notification(out, filename, 2);
            try {
