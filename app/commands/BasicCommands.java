...
public class BasicCommands {
     ...
     * @param out
     * @param tile
     * @param mode 0: un-highlighted, 1: white-highlighted, 2: red-highlighted
     */
     ...
     *
     * @param out    ActorRef, responsible for sending command to the front-end
     * @param unit
     * @param attack int: value between 0 and 20
     */
    @SuppressWarnings({"deprecation"})
     ...
     * @param out    ActorRef, responsible for sending command to the front-end
     * @param unit
     * @param health int: value between 0 and 20
     */
    @SuppressWarnings({"deprecation"})
     ...
     * @param out
     * @param card
     * @param position between 1 and 6
     * @param mode     0: un-highlighted, 1: white-highlighted, 2: red-highlighted
     */
    @SuppressWarnings({"deprecation"})
