...
public class ImageListForPreLoad {
    ...
    public static Set<String> getImageListForPreLoad() {
        ...
        // Tiles
        images.addAll(Tile.constructTile(StaticConfFiles.TILE_CONF).getTileTextures());

        // Avatars
        images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.HUMAN_AVATAR, -1, Unit.class).getAnimations().getAllFrames());
        images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.AI_AVATAR, -1, Unit.class).getAnimations().getAllFrames());
